...
> **👤 Owner**: `devteam-arch`
> **🔖 Version**: v{n}
> **🔗 Related**: [`docs/architecture/c4-l1-{feature}.md`](./c4-l1-{feature}.md)
...
> [!TIP]
> **TL;DR (30s)**: Container view: **{N} containers** (frontend / API / DB / queue / cache). Communication: **{protocols}**. Key dependencies: **{top 2-3}**.

| 維度 | 摘要 |
|:---|:---|
| **🎯 Containers** | {N} runtime units |
| **🔌 Protocols** | REST · gRPC · message queue · WebSocket |
| **💾 Stateful** | {DB / cache / storage names} |
| **🚀 狀態** | {emoji} {status} |
